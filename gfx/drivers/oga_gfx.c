        ...
        input_driver_t **input, void **input_data)
{
   ...
   vid->frame_surface = oga_create_surface(vid->fd, video->width, video->height, vid->bpp == 4 ? RK_FORMAT_BGRA_8888 : RK_FORMAT_RGB_565);
        ...
        unsigned pitch, const char *msg, video_frame_info_t *video_info)
{
   ...
   if (blit_msg)
   {
      oga_blit(vid->msg_surface, 0, 0, vid->msg_width, vid->msg_height,
            ...
            HAL_TRANSFORM_ROT_270, vid->scale_mode, 0 /* 0xff0105 */);
   }
